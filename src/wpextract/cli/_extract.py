...
from wpextract.cli._shared import directory, empty_directory, logging_options, setup_logging, setup_tqdm_redirect, \
    CMD_ARGS
...
@click.option("-S", "--scrape-root", help="Root directory of an HTML scrape", type=directory)
@click.option("-P", "--json-prefix", help="Prefix to use for input and output filenames")
@logging_options
def extract(json_root: Path,
            out_dir: Path,
